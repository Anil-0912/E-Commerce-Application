  ...
  return (
    <div>
        ...
        <div className="mb-4">
          ...
          <input type="text" placeholder="Enter image URL" name='img' value={formData.img} className="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-500" onChange={handleChange} required />
        </div>
